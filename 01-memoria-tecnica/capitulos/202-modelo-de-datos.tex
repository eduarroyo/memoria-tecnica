...
\subsection{Categorías-Comunicación}
\subsubsection*{Descripción}
...
\subsubsection*{Atributos de la interrelación}
La tabla \ref{cuadro:ejemplo-tipo-interrelacion-usuarios-comunicaciones} muestra cómo se forma la interrelación, así como ejemplos de valores de los atributos implicados.
\begin{table}[h]
    \rowcolors{2}{gray!25}{white}
    \centering
    \begin{tabular}{|llclp{6.5cm}|}
...
\begin{table}[h]
    ...
    \begin{tabular}{|llclp{4.2cm}|}
        ...
        \hline
    \end{tabular}%}
    \caption{Ejemplo de interrelación Documentos-Comunicaciones (b)}
...
\begin{table}[h]
    ...
    \begin{tabular}{|llclp{5.2cm}|}
        ...
        Terminales & TerminalID & \cmark & 123 & ID del terminal que realiza el acceso \\
         ...
         & Fecha & \cmark & 2020-11-20 10:37:12 & Fecha y hora del acceso \\
        \hline
    \end{tabular}%}
