...
% Numeración arábiga para listas enumeradas anidadas
\setlist[enumerate,1]{label=\arabic*.,ref=\arabic*}
\setlist[enumerate,2]{label=\theenumi.\arabic*.,ref=\theenumi.\arabic*}
\setlist[enumerate,3]{label=\theenumi.\theenumii.\arabic*.,ref=\theenumii.\arabic*}
\setlist[enumerate,4]{label=\theenumi.\theenumii.\theenumiii.\arabic*.,ref=\theenumiv.\arabic*}
\begin{document}
%\frontmatter
...
\mainmatter
\part{Presentación}
\include{capitulos/101-introduccion}
\include{capitulos/102-definicion-del-problema}
\include{capitulos/103-objetivos}
\include{capitulos/104-antecedentes}
\include{capitulos/104-limitaciones}
\include{capitulos/105-recursos}
\part{Análisis del sistema}
\include{capitulos/201-especificacion-de-requisitos}
\include{capitulos/202-modelo-de-datos}
\include{capitulos/203-analisis-funcional}
\part{Diseño}
\include{capitulos/301-diseño-de-datos}
\include{capitulos/302-arquitectura}
\include{capitulos/303-bibliotecas-de-negocio}
\include{capitulos/304-aplicacion-web}
\include{capitulos/305-servicio-web}
\include{capitulos/306-programas-auxiliares}
\include{capitulos/307-aplicacion-movil-tipo}
\part{Pruebas}
\part{Conclusiones y futuras mejoras}
\include{capitulos/501-conclusiones}
\include{capitulos/502-futuras-mejoras}
\cleardoublepage
